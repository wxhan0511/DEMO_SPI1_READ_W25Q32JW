...
HAL_StatusTypeDef HAL_I2C_Slave_Transmit(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      I2C_DEBUG("[I2C] Slave_Transmit: Invalid parameter\r\n");
      return  HAL_ERROR;
    }
    ...
    {
      I2C_DEBUG("[I2C] Slave_Transmit: Wait ADDR timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
      return HAL_ERROR;
    }
    ...
    if (hi2c->Init.AddressingMode == I2C_ADDRESSINGMODE_10BIT)
    {
      if (I2C_WaitOnFlagUntilTimeout(hi2c, I2C_FLAG_ADDR, RESET, Timeout, tickstart) != HAL_OK)
      {
        I2C_DEBUG("[I2C] Slave_Transmit: Wait ADDR(10bit) timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
        return HAL_ERROR;
      }
      __HAL_I2C_CLEAR_ADDRFLAG(hi2c);
    }
    ...
    while (hi2c->XferSize > 0U)
    {
      if (I2C_WaitOnTXEFlagUntilTimeout(hi2c, Timeout, tickstart) != HAL_OK)
      {
        I2C_DEBUG("[I2C] Slave_Transmit: Wait TXE timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
        CLEAR_BIT(hi2c->Instance->CR1, I2C_CR1_ACK);
        return HAL_ERROR;
      }
    ...
    {
      I2C_DEBUG("[I2C] Slave_Transmit: Wait AF timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
      return HAL_ERROR;
    }
  ...
  {
    I2C_DEBUG("[I2C] Slave_Transmit: I2C busy\r\n");
    return HAL_BUSY;
  }
}
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    {
      I2C_DEBUG("[I2C] Slave_Receive: Invalid parameter\r\n");
      return HAL_ERROR;
    }
    ...
    SET_BIT(hi2c->Instance->CR1, I2C_CR1_ACK);
    //I2C_DEBUG("[I2C] Slave_Receive: ADDR flag=0x%08lX\r\n", __HAL_I2C_GET_FLAG(hi2c, I2C_FLAG_ADDR));
    /* Wait until ADDR flag is set */
    if (I2C_WaitOnFlagUntilTimeout(hi2c, I2C_FLAG_ADDR, RESET, Timeout, tickstart) != HAL_OK)
    {
      //I2C_DEBUG("[I2C] Slave_Receive: Wait ADDR timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
      return HAL_ERROR;
    }
    ...
    while (hi2c->XferSize > 0U)
    {
      ...
      if (I2C_WaitOnRXNEFlagUntilTimeout(hi2c, Timeout, tickstart) != HAL_OK)
      {
        I2C_DEBUG("[I2C] Slave_Receive: Wait RXNE timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
    ...
    {
      I2C_DEBUG("[I2C] Slave_Receive: Wait STOP timeout or error, ErrorCode=0x%08lX\r\n", hi2c->ErrorCode);
      /* Disable Address Acknowledge */
      CLEAR_BIT(hi2c->Instance->CR1, I2C_CR1_ACK);
  ...
  {
    //I2C_DEBUG("[I2C] Slave_Receive: I2C busy\r\n");
    return HAL_BUSY;
  }
}
